...
ALTER TABLE USER
ADD FOREIGN KEY (current_topic) REFERENCES CHATROOM(id) ON UPDATE CASCADE;
...
CREATE TABLE IF NOT EXISTS subscription (
	handle_user VARCHAR(10) NOT NULL REFERENCES USER(handle) ON UPDATE CASCADE,
  id_chatroom INT NOT NULL REFERENCES CHATROOM(id) ON UPDATE CASCADE,
  PRIMARY KEY(handle_user,id_chatroom)
);
